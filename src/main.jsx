...
import StockApp from "./views/homeworks/stock-app/index.jsx";
import TodoList from "./views/homeworks/todo-list/index.jsx";
import UserRoles from "./views/homeworks/user-roles/index.jsx";
